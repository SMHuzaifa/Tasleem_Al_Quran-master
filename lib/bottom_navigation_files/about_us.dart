                    ...
                    child: GestureDetector(
                      onTap: () {
                        PersistentNavBarNavigator.pushNewScreenWithRouteSettings(
                          context,
                          settings: const RouteSettings(name: RoutesName.saadArshad),
                          screen:  SaadArshad(),
                          withNavBar: true,
                        ...
                        child: CircleAvatar(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              PersistentNavBarNavigator.pushNewScreenWithRouteSettings(
                                context,
                                settings: const RouteSettings(name: RoutesName.iqraAsad),
                                screen:  IqraAsad(),
                                withNavBar: true,
                                pageTransitionAnimation: PageTransitionAnimation.cupertino,
                              );
                        ...
                        child: CircleAvatar(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              PersistentNavBarNavigator.pushNewScreenWithRouteSettings(
                                context,
                                settings: const RouteSettings(name: RoutesName.ayeshaJadoon),
                        ...
                        child: CircleAvatar(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              PersistentNavBarNavigator.pushNewScreenWithRouteSettings(
                                context,
                                settings: const RouteSettings(name: RoutesName.noreebaEffendi),
                        ...
                        child: CircleAvatar(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              PersistentNavBarNavigator.pushNewScreenWithRouteSettings(
                                context,
                                settings: const RouteSettings(name: RoutesName.sabahMalik),
